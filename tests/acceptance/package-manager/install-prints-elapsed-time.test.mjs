...
test("install prints elapsed time after packages are installed", async (t) => {
  ...
  assert.match(install.stderr, /1 packages installed/);
  assert.match(install.stderr, /\d+ms|\d+\.\d+s/);
});
