...
test("install skips an optional dependency that does not match this CPU", async (t) => {
  const extraTar = npmTarball({
    "package.json": JSON.stringify({
      name: "knot-fixture-ia32-only",
      version: "1.0.0",
      type: "module",
      cpu: ["ia32"],
      exports: "./index.js",
    }),
    "index.js": "export function extraName() { return \"ia32\"; }\n",
  });
  const userTar = npmTarball({
    "package.json": JSON.stringify({
      name: "knot-fixture-optional-cpu-user",
      version: "1.0.0",
      type: "module",
      exports: "./index.js",
      optionalDependencies: {
        "knot-fixture-ia32-only": "1.0.0",
      },
    }),
    "index.js": "export function hello() { return \"ok\"; }\n",
  });
  const pkgs = {
    "knot-fixture-ia32-only": {
      version: "1.0.0",
      tarball: extraTar,
      integrity: sriSha512(extraTar),
      cpu: ["ia32"],
    },
    "knot-fixture-optional-cpu-user": {
      version: "1.0.0",
      tarball: userTar,
      integrity: sriSha512(userTar),
    },
  };
  ...
  const workspace = await makeWorkspace({
    "package.json": JSON.stringify({
      ...
      type: "module",
      dependencies: {
        "knot-fixture-optional-cpu-user": "1.0.0",
      },
    }, null, 2),
  });
  ...
  assert.match(lock, /name knot-fixture-optional-cpu-user/);
  assert.doesNotMatch(lock, /name knot-fixture-ia32-only/);

  const imported = await runProcess(process.execPath, [
    "--input-type=module",
    "-e",
    "import { hello } from \"knot-fixture-optional-cpu-user\"; console.log(hello());",
  ], { cwd: workspace });
