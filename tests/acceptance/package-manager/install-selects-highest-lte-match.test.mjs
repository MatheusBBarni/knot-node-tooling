...
test("install selects the highest version that satisfies a less-or-equal range", async (t) => {
  ...
  assert.match(lock, /version 1\.5\.0/);
  ...
  assert.equal(imported.stdout, "v1.5.0\n");
});
