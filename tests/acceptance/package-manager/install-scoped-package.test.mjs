...
test("install downloads a scoped package and lets Node.js import it", async (t) => {
  const registry = startRegistry({
    ...
    files: {
      ...
      "index.js": "export function hello() { return \"hello from scoped\"; }\n",
    },
  });
  ...
  assert.equal(imported.stdout, "hello from scoped\n");
});
