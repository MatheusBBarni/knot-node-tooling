...
test("install extracts a relative symlink inside a package tarball", async (t) => {
    ...
    versions: [
      {
        ...
        files: {
          ...
          "index.js": "export function hello() { return \"via symlink\"; }\n",
        },
        symlinks: {
          "lib.js": "./index.js",
        },
  ...
  assert.equal(imported.stdout, "via symlink\n");
});
