...
test("install selects the highest version that satisfies a union range", async (t) => {
  const registry = startRegistry({
    name: pkgName,
    versions: [
      { version: "1.5.0", files: pkgFiles("1.5.0", "v1.5.0") },
      { version: "2.0.0", files: pkgFiles("2.0.0", "v2.0.0") },
      { version: "3.0.0", files: pkgFiles("3.0.0", "v3.0.0") },
    ],
  });
  ...
  assert.doesNotMatch(lock, /version 3\.0\.0/);
