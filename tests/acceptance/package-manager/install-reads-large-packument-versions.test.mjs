...
test("install reads a packument whose versions list is larger than 64KiB", async (t) => {
  const registry = startRegistry({
    name: pkgName,
    extraVersions: extraVersions(8_500),
    versions: [
      {
        version: "1.0.0",
        files: {
          ...
          "index.js": "export function hello() { return \"from large packument\"; }\n",
        },
      },
    ],
  });
  ...
  assert.equal(imported.stdout, "from large packument\n");
});
