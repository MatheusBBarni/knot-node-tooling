...
test("install extracts a tarball whose root directory is not package/", async (t) => {
    ...
    versions: [
      {
        ...
        files: {
          ...
          "index.js": "export function hello() { return \"from named tar root\"; }\n",
        },
      },
    ],
  });
  ...
  assert.equal(imported.stdout, "from named tar root\n");
});
