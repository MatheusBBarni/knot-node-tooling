...
test("install selects the highest version that satisfies a less-than range", async (t) => {
  ...
  assert.doesNotMatch(lock, /version 1\.5\.0/);
  ...
  assert.equal(imported.stdout, "v1.0.0\n");
});
