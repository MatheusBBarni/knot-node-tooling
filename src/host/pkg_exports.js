function pkg_exports(text, subpath, conditions) {
  try {
    ...
    const r = spawnSync(
      process.execPath,
      [`${root}/scripts/pkg-exports.mjs`, "resolve", subpath || ".", conditions || "import,module,node,default"],
      { input: text, encoding: "utf8" },
    );
    if (r.status !== 0) return io_fail(2);
